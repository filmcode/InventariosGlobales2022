<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="/observaciones/edit/{{$id}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid">
                     <div class="grid grid-cols-1 p-10">
                        ...
                        <textarea name="descripcion" cols="30" rows="10" class="py-2 px-3 rounded-lg border-2 mt-1 focus:outline-none focus:ring-2 md-textarea form-control">{{$observacion->descripcion}}</textarea>
                    </div>
                </div>
